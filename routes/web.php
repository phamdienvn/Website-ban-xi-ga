...
Route::group(['middleware' => ['admin','locale','backend_default_locale']], function () {
   ...
   Route::group(['prefix' => 'users/catalogue'], function () {
   ...
   Route::group(['prefix' => 'posts/catalogue'], function () {
   ...
   Route::group(['prefix' => 'products/catalogue'], function () {
   ...
   Route::group(['prefix' => 'attributes/catalogue'], function () {
