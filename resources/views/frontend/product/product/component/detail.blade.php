        ...
        <div class="uk-width-large-1-2">
            <div class="popup-product">
                ...
                <div class="product-specs">
                    <div class="spec-row masp">Mã sản phẩm: <strong>{{ $product->code }}</strong></div>
                    ...
                    <div class="uk-width-large-1-2">
                        <div class="a-left">
                            ...
                            <div class="price-save">
                                ...
                                {{-- Tiết kiệm: <strong>{{ $price['priceSale'] == 0 ? 0 : number_format(convert_price($price['price'] - $price['priceSale'], 0, ',', '.')) }}</strong> (<span style="color:red">-{{ number_format($price['percent'], 0, ',', '.') }}%</span>) --}}
                                Tiết kiệm: <strong>{{ $price['priceSale'] == 0 ? 0 : number_format((float) convert_price($price['price'] - $price['priceSale']), 0, ',', '.') }}</strong> (<span style="color:red">-{{ number_format((float) $price['percent'], 0, ',', '.') }}%</span>)
                            </div>
                            @endif
                            ...
                            <div class="quantity mt10">
                                <div class="uk-flex uk-flex-middle mb10">
                                    <div class="quantitybox uk-flex uk-flex-middle">
                                        ...
                                        <input type="text" name="" value="1" class="quantity-text input-qty">
                                        <div class="plus quantity-button">+</div>
                                    </div>
                                </div>
                                <div class="uk-flex uk-flex-middle mb10">
                                    <div class="btn-group uk-flex uk-flex-middle mr10">
                                    ...
                                    <div class="btn-group uk-flex uk-flex-middle">
                                        <div class="btn-item btn-1 addCart" data-id="{{ $product->id }}">
                ...
                <div class="panel-body list-product">
                    ...
                    <div class="uk-grid uk-grid-medium">
                        ...
                        <div class="uk-width-1-2 uk-width-small-1-2 uk-width-medium-1-3 uk-width-large-1-5 mb20">
                            ...
                            {{-- {{print_r($product->promotions->discountValue)}} --}}
                        {{-- </div>
                        @endforeach
                    </div>
                    @endif --}} 
...
<input type="hidden" class="productCanonical" value="{{ write_url($canonical) }}">
