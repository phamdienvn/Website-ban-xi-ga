...
return [
    ...
    'distribution' => [
        'index' => [
            ...
            'table' => 'Danh sách Hệ thống phân phối',
        ],
        'create' => [
            'title' => 'Thêm mới Hệ thống phân phối',
        ],
    ],
    'source' => [
        'index' => [
    ...
    'construct' => [
        'index' => [
            'title' => 'Quản lý Công trình',
            'table' => 'Danh sách Công trình',
        ],
        'create' => [
            'title' => 'Thêm mới Công trình'
        ],
        'edit' => [
            'title' => 'Cập nhật thông tin Công trình'
        ],
        'delete' => [
            'title' => 'Xóa thông tin Công trình'
        ],
    ],
    'warranty' => [
        'index' => [
